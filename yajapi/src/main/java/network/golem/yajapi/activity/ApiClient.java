...
import network.golem.yajapi.activity.auth.Authentication;
import network.golem.yajapi.activity.auth.HttpBasicAuth;
import network.golem.yajapi.activity.auth.ApiKeyAuth;
import network.golem.yajapi.activity.auth.OAuth;

public class ApiClient {
  protected Map<String, String> defaultHeaderMap = new HashMap<String, String>();
  protected String basePath = "/activity-api/v1";
  ...
  public ApiClient() {
    ...
    authentications.put("app_key", new ApiKeyAuth("header", "authorization"));
