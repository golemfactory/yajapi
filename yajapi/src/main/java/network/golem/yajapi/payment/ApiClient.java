...
import network.golem.yajapi.payment.auth.Authentication;
import network.golem.yajapi.payment.auth.HttpBasicAuth;
import network.golem.yajapi.payment.auth.ApiKeyAuth;
import network.golem.yajapi.payment.auth.OAuth;

public class ApiClient {
  protected Map<String, String> defaultHeaderMap = new HashMap<String, String>();
  protected String basePath = "/payment-api/v1";
