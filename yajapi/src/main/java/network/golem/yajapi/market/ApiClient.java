...
import network.golem.yajapi.market.auth.Authentication;
import network.golem.yajapi.market.auth.HttpBasicAuth;
import network.golem.yajapi.market.auth.ApiKeyAuth;
import network.golem.yajapi.market.auth.OAuth;

public class ApiClient {
  protected Map<String, String> defaultHeaderMap = new HashMap<String, String>();
  protected String basePath = "/market-api/v1";
